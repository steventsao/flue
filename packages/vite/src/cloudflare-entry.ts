...
export interface GenerateCloudflareEntryOptions {
	...
	/**
	 * The target the entry is generated for. celld runs the same Worker +
	 * Durable Object code as Cloudflare, so this changes only the header
	 * comment. Defaults to `'cloudflare'`.
	 */
	readonly target?: 'cloudflare' | 'celld';
}
...
export function generateCloudflareEntry(options: GenerateCloudflareEntryOptions): string {
	...
	return `// Auto-generated by @flue/vite (target: ${options.target ?? 'cloudflare'}). Do not edit.
/* eslint-disable */
// @ts-nocheck
